...
int importSelected =
    0; // depending on what this number is is what database operation is performed
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: TextButton(
                    child: Text(
                      "Import CSV Store List",
                    ), //TODO: Create  one that imports quantity data just so I can build a detailed quantity graph quickly
            ...
            ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  try {
                    ...
                    Database.addStore(
                        name: itemData[index][0], address: itemData[index][1]);
                  } catch (exception) {
                    return Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Container(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text("ERROR importing row containing [" +
                                  itemData[index][0] +
                                  ", " +
                                  itemData[index][1] +
                                  "]. Please make sure row conforms to CSV import guidelines."),
                            ],
                          ),
                        )),
                      ),
      ...
      if (files!.length == 1) {
        ...
        reader.onLoadEnd.listen((e) {
          setState(() async {
            ...
            final fields =
                CsvToListConverter().convert(utf8.decode(uploadedCsv));
            print(fields);
            setState(() {
              itemData = fields;
            });
