    ...
    body: Center(
      child: Column(
        children: [
          ...
          Text('Been a few minutes and you didn\'t get the email? Click the button below to resend.',
                  style: GoogleFonts.lato(
                  textStyle:TextStyle(
                                    color: Colors.grey,
                                    fontSize: 16
          ...
          ElevatedButton(
                      style: ElevatedButton.styleFrom(primary: Color(0xFF73AEF5)),
                      child: Text('Resend Password Reset Email'),  //TODO: build out a way to resend the verification email here.
                      //when pressed, pass email and password to _signin function
                      onPressed: () async {
                        try{
                          print('the email is ' + _email);
