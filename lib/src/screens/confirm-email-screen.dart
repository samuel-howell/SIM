    ...
    body: Center(
      child: Column(
        children: [
          ...
          Text('Email confirmation has been sent to your email address. After you accept, please click the button below',
          ...
          ElevatedButton(
                      style: ElevatedButton.styleFrom(primary: Color(0xFF73AEF5)),
                      child: Text('Resend Verification Email'),  //TODO: build out a way to resend the verification email here.
                      //when pressed, pass email and password to _signin function
                      onPressed: () async {
                      Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => LoginScreen(),
