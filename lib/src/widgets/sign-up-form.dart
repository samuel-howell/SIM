        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            validator: (value) { // The validator receives the text that the user has entered.
              if (value == null || value.isEmpty) { //TODO: put a regex here that can accept str like "Samuel", but not sql injection type of stuff.  apply same regex at all similar fields.
