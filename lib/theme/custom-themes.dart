...
class CustomTheme {
  static ThemeData get lightTheme { //1
    return ThemeData( //2
      appBarTheme: AppBarTheme(backgroundColor: CustomColors.red), // hot reload will not change it. only hot restart. also, this was a regression problem at flutter 2.5 using AppBarTheme is the workaround
